...
4.  **Opis kroków (skrót):** \* Użytkownik wypełnia formularz -> Supabase zwraca sesję -> Frontend wysyła sesję do API -> API ustawia ciasteczka -> Następuje przekierowanie lub przeładowanie -> Middleware widzi ciasteczka i wpuszcza użytkownika.
    </authentication_analysis>
